...
cd src
make
//make modified version of testrpitx and run (also install requierements, or you will get errors)
cd ..
cd app
make
...
The same thing applies here! The transmission is not very stable, has alot of harmonics and it is definitelly not legal in this sense. The range can be few meters, so dont transmit on bad frequencies or at least add a filter!
# External references
